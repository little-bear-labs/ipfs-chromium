...
void ctx::LoadStaticGatewayList(ipfs::ctx::GatewayConfig& cfg) {
  auto static_list = {
      std::pair<std::string_view, int>{"http://127.0.0.1:8080/", 12'040},
      {"https://jcsl.hopto.org/", 451},
      {"https://ipfs.io/", 425},
      {"https://gateway.ipfs.io/", 392},
      {"https://ipfs.eth.aragon.network/", 299},
      {"https://cloudflare-ipfs.com/", 241},
      {"https://ipfs.greyh.at/", 190},
      {"https://cf-ipfs.com/", 119},
      {"https://ipfs.joaoleitao.org/", 71},
      {"https://ipfs.fleek.co/", 46},
      {"https://trustless-gateway.link/", 24},
      {"https://dag.w3s.link/", 15},
      {"https://hardbin.com/", 14},
      {"https://delegated-ipfs.dev/", 13},
      {"https://dweb.link/", 12},
