...
void ctx::LoadStaticGatewayList(ipfs::ctx::GatewayConfig& cfg) {
  auto static_list = {
      std::pair<std::string_view, int>{"http://127.0.0.1:8080/", 1032},
      {"https://ipfs.io/", 1006},
      {"https://dweb.link/", 952},
      {"https://trustless-gateway.link/", 948},
      {"https://hardbin.com/", 930},
      {"https://ipfs.greyh.at/", 868},
      {"https://ipfs.joaoleitao.org/", 867},
      {"https://dlunar.net/", 708},
      {"https://flk-ipfs.io/", 692},
      {"https://ipfs.cyou/", 480},
      {"https://human.mypinata.cloud/", 421},
      {"https://jcsl.hopto.org/", 381},
      {"https://delegated-ipfs.dev/", 333},
      {"https://4everland.io/", 307},
      {"https://ipfs.runfission.com/", 277},
      {"https://gateway.pinata.cloud/", 150},
      {"https://dag.w3s.link/", 144},
