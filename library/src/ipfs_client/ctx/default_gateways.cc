...
void ctx::LoadStaticGatewayList(ipfs::ctx::GatewayConfig& cfg) {
  auto static_list = {
      std::pair<std::string_view, int>{"http://127.0.0.1:8080/", 1031},
      {"https://ipfs.io/", 1008},
      {"https://dweb.link/", 953},
      {"https://trustless-gateway.link/", 949},
      {"https://hardbin.com/", 931},
      {"https://ipfs.greyh.at/", 869},
      {"https://ipfs.joaoleitao.org/", 868},
      {"https://dlunar.net/", 709},
      {"https://flk-ipfs.io/", 693},
      {"https://ipfs.cyou/", 481},
      {"https://human.mypinata.cloud/", 422},
      {"https://jcsl.hopto.org/", 382},
      {"https://delegated-ipfs.dev/", 334},
      {"https://4everland.io/", 308},
      {"https://ipfs.runfission.com/", 278},
      {"https://gateway.pinata.cloud/", 151},
      {"https://dag.w3s.link/", 145},
