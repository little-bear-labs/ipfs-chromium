...
void ctx::LoadStaticGatewayList(ipfs::ctx::GatewayConfig& cfg) {
  auto static_list = {
      std::pair<std::string_view, int>{"http://127.0.0.1:8080/", 1000},
      {"https://ipfs.io/", 992},
      {"https://dweb.link/", 985},
      {"https://hardbin.com/", 969},
      {"https://ipfs.joaoleitao.org/", 904},
      {"https://ipfs.greyh.at/", 903},
      {"https://trustless-gateway.link/", 790},
      {"https://human.mypinata.cloud/", 454},
      {"https://delegated-ipfs.dev/", 368},
      {"https://jcsl.hopto.org/", 357},
      {"https://4everland.io/", 339},
      {"https://ipfs.runfission.com/", 308},
      {"https://gateway.pinata.cloud/", 205},
      {"https://dag.w3s.link/", 178},
